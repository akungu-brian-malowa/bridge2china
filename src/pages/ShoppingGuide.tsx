import { FaShoppingCart, FaShippingFast, FaSearch, FaCheckCircle, FaStar, FaTruck } from 'react-icons/fa';
...
const ShoppingGuide = () => {
  ...
  const categories = [
    {
      ...
      items: ['Phones & accessories', 'Computers & parts', 'Smart home devices', 'Power banks', 'Smart watches', 'Camera equipment'],
      icon: '📱'
    },
    {
      title: 'Fashion & Apparel',
      items: ['Clothing & shoes', 'Bags & accessories', 'Jewelry & watches', 'Sunglasses', 'Sportswear', 'Traditional outfits'],
      icon: '👗'
    },
    {
      title: 'Home & Kitchen',
      items: ['Cookware & utensils', 'Home decor', 'Furniture', 'Lighting', 'Bedding', 'Smart appliances'],
      icon: '🏠'
    },
    {
      title: 'Beauty & Personal Care',
      items: ['Skincare products', 'Makeup', 'Hair care', 'Fragrances', 'Beauty tools', 'Personal gadgets'],
      icon: '💄'
    },
    {
      title: 'Toys & Games',
      items: ['Educational toys', 'Electronic toys', 'Board games', 'Outdoor toys', 'Collectibles', 'Puzzles'],
      icon: '🧸'
    },
    {
      title: 'Industrial Supplies',
      items: ['Machinery parts', 'Raw materials', 'Packaging', 'Tools & equipment', 'Safety gear', 'Electrical components'],
      icon: '⚙️'
    }
  ];
  ...
  // Shopping tips
  const tips = [
    { title: 'Verify Suppliers', icon: <FaSearch />, description: 'Always check seller ratings and reviews before purchasing' },
    { title: 'Order Samples', icon: <FaCheckCircle />, description: 'Request product samples before placing large orders' },
    { title: 'Negotiate Prices', icon: <FaStar />, description: 'Most suppliers are open to negotiation, especially on bulk orders' },
    { title: 'Understand Shipping', icon: <FaTruck />, description: 'Factor in shipping costs and timelines when planning orders' }
  ];
      ...
      <div className="pt-24 pb-16 px-4 text-center bg-gradient-to-r from-[#8a6725] to-[#6a4f1d] text-white mt-24">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl mb-8">
            Your comprehensive resource for sourcing products from China's vast market
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              China offers an unparalleled variety of products across numerous categories
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 bg-white rounded-xl p-8 max-w-4xl mx-auto shadow-lg">
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#8a6725] mb-3">Platform Selection Tip</h3>
                <p className="text-gray-700">
                  Choose platforms based on your needs: Alibaba and DHgate are best for wholesale, 
                  AliExpress for small quantity orders, and Tmall for authentic branded products. 
                  For fashion, Shein offers trendy items at competitive prices.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {tips.map((tip, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-3 text-[#8a6725]">{tip.title}</h3>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            <div className="bg-[#8a6725] text-white p-8 rounded-xl">
              <h3 className="text-xl font-bold mb-4">Avoid These Common Mistakes</h3>
              <ul className="space-y-2">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <h3 className="text-xl font-bold mb-4 text-[#8a6725]">Best Practices</h3>
              <ul className="space-y-2">
                <li className="flex items-start">
                  <span className="text-[#8a6725] mr-2">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-[#8a6725] mr-2">•</span>
                  <span>Communicate clearly and confirm all details in writing</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#8a6725] mr-2">•</span>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p>We handle supplier identification, negotiation, and ordering</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p>Our team performs thorough quality inspections before shipping</p>
            </div>
